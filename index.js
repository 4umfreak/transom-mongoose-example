...
transom.initialize(myApi).then(function (server) {
  ...
  server.get('/', function (req, res, next) {
    const links = [
      ...
      '/api/v1/db/address',
      '/api/v1/db/address?_sort=city&_select=city',
      '/api/v1/db/address?_sort=city&_collation=usorted&_select=city',
      '/api/v1/db/address?_sort=city&_collation=default&_select=city',
